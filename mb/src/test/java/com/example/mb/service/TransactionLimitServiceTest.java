...
public class TransactionLimitServiceTest {
    ...
    public void init() {
    	...
    	Customer customer = new Customer(1L, "John Doe", "johndoe123", "9876543210", "johndoe@example.com", 
                "123 Street, City", LocalDate.of(1990, 1, 1), "Bachelors", 
                "Software Engineer", "Single", "ABCDE1234F", "1234-5678-9012", branch);
